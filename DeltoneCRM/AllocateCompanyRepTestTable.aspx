<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/NoNav.Master" CodeBehind="AllocateCompanyRepTestTable.aspx.cs" Inherits="DeltoneCRM.AllocateCompanyRepTestTable" %>
        ...
        function CreateTableData(catValue, dirc, colNumber, startDate, endDate) {
...

            {
                table = $('#livedbtbl').DataTable({
                    ...
                    bServerSide: true,
                    "iDisplayLength": 100,
                    sAjaxSource: "../Fetch/FetchSampleAllocateCompanyByRepTest.aspx?n=1",
