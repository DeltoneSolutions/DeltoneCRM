<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/NoNav.Master" CodeBehind="CustomerByProductForRe.aspx.cs" ValidateRequest="false"
    Inherits="DeltoneCRM.Reports.CustomerByProductForRe" %>
        ...
        $(function () {
            $('#<%=searchTextBox.ClientID%>').autocomplete({
                source: function (request, response) {
                    $.ajax({
                        type: "POST",
                        url: "CustomerByProductForRe.aspx/GetProductCode",
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:ListItem Text="100" Value="100" />
        ...
        <asp:DropDownList ID="ddlRepList" runat="server" Visible="false">
        </asp:DropDownList>
        <input type="button" id="prBtn" style="color: blue; cursor: pointer;display:none;" value="Print" onclick="PrintPage();" />
        ...
        <asp:Button ID="downloadCSVFile" runat="server" ForeColor="Blue" CssClass="styleCommon" Font-Bold="true" Width="10%"  Text="Download CSV"  OnClick="CreateDownloadFile"/>
        <br />
        <br />
        <table width="100%" id="pnlGridView" runat="server" align="center" class="ContentTable">
           
            <tr style="display:none;"><td>Email Subject:</td>
                </tr>
               <tr style="display:none;">  <td><asp:TextBox ID="subjectMessage" runat="server" Width="40%" Height="30%"></asp:TextBox> </td></tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:Button ID="sendEmailbutton" Visible="false" runat="server" Text="Send Email" CssClass="styleCommon" OnClick="sendEmail" ForeColor="Blue" Font-Bold="true" Width="48%" Height="45%" />
                </td>
            </tr>
            <tr>
                <td></td>
