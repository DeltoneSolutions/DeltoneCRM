...
{
    public partial class dorepAllocation : System.Web.UI.Page
    {
    ...
    public class RepCompanyAllocationSec
    {
        public string CompanyOwnerRepName { get; set; }
        public string AllocateRepName { get; set; }
        public int AllocationMode { get; set; }
        public int AllocationPeriod { get; set; }
        public string NumberOfAllocationCom { get; set; }
        public bool IsFilterApplied { get; set; }
        public string StartDate { get; set; }
        public string EndDate { get; set; }
        public IList<SelectedCompany> SelectedCompanies { get; set; }
    }
