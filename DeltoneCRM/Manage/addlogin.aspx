<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addlogin.aspx.cs" Inherits="DeltoneCRM.Manage.addlogin" %>
        ...
        $(document).ready(function () {
            ...
            $("#<%=form1.ClientID%>").validate({
                 ...
                 submitHandler: function (form) {
                     $.ajax({
                         type: "POST",
                         url: "Process/Process_AddLogin.aspx",
                         data: {
                            ...
                            <tr>
                              <td width="315"><table width="315" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td width="215"><input name="NewFirstName" type="text" class="txtbox-200-style-edit" id="NewFirstName" /></td>
                                </tr>
                              </table></td>
                              <td width="20">&nbsp;</td>
                              <td width="315"><table width="315" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td width="200"><input name="NewLastName" type="text" class="txtbox-200-style-edit" id="NewLastName" /></td>
                                </tr>
                              </table></td>
                            </tr>
                          </table></td>
                            ...
                            <tr>
                              <td width="315"><table width="315" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td width="215"><input name="NewUsername" type="text" class="txtbox-200-style-edit" id="NewUsername" /></td>
                                </tr>
                              </table></td>
                              <td width="20">&nbsp;</td>
                              <td width="315"><table width="315" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td width="200"><input name="NewPassword" type="text" class="txtbox-200-style-edit" id="NewPassword" /></td>
                                </tr>
                              </table></td>
                            </tr>
                          </table></td>
                            ...
                            <tr>
                              <td width="315"><table width="315" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td width="215"><select name="accesslevel" class="drpdwn-200-style-edit" id="accesslevel">
  ...
  <option value="2">Standard User</option>
                              ...
                              <td width="315"><table width="315" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td width="200"><input name="ConfirmPassword" type="text" class="txtbox-200-style-edit" id="ConfirmPassword" /></td>
                                </tr>
                              </table></td>
                            </tr>
                          </table></td>
                            ...
                            <tr>
                              <td width="315"><table width="315" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td width="215"><input name="NewEmailAddy" type="text" class="txtbox-200-style-edit" id="NewEmailAddy" /></td>
                                </tr>
                              </table></td>
                              <td width="20">&nbsp;</td>
                                  ...
                                  <td width="215"><select name="department" class="drpdwn-200-style-edit" id="department">
                                      <option value="">-- SELECT --</option>
