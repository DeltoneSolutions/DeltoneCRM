<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editOrContinueContact.aspx.cs" Inherits="DeltoneCRM.Manage.editOrContinueContact" %>
    ...
    <script src="../../js/tinytools.toggleswitch.js" type="text/javascript"></script>
     ...
     <script type="text/javascript">
         ...
         $(document).ready(function () {
             ...
             if ($("#quoteTypeCustomer").val() == "LiveDb") {
                 $('#BtnCloseWindow').show();
             }
                         ...
                         if ($("#quoteTypeCustomer").val() == "LiveDb") {
                             $.ajax({
                                 ...
                                 success: function (msg) {
                                     ...
                                     contactIdNew = $('#NewContactID').val();
                                     $('#BtnCloseWindow').show();
                                     //window.parent.CreateOrder($('#NewContactID').val(), $('#OldCompanyID').val());
                             ...
                             $.ajax({
                                 ...
                                 success: function (msg) {
                                     //alert(msg);
                                     alert('This contact has been successfully created');
                                     $('#BtnCloseWindow').show();
                                     contactIdNew = msg.split(':')[1];
                                     $('#NewContactID').val(contactIdNew);
         ...
         function callOrderPage() {
             window.parent.CreateOrder($('#NewContactID').val(), $('#CompID').val());
         }
                            ...
                            <tr>
                              ...
                              <td width="315">
                                  ...
                                  <input name="OldCompanyID" type="text" class="txtbox-200-style" id="OldCompanyID" hidden="hidden"  readonly="true" runat="server" />
                                   <input name="quoteTypeCustomer" type="text" class="txtbox-200-style" id="quoteTypeCustomer" hidden="hidden"  readonly="true" runat="server" />
                                   <input name="CompID" type="text" class="txtbox-200-style" id="CompID" hidden="hidden"  readonly="true" runat="server" />
                                </td>
                            </tr>
                          </table></td>
                        </tr>
                                  ...
                                  <td width="270px">
                                      <table align="right" cellpadding="0" cellspacing="0" class="auto-style2">
                                          <tr>
                                              ...
                                              <td width="15px">&nbsp;</td>
                                              <td width="125px">
                                                  <input type="button" id="BtnCloseWindow" style="display:none;" class="btn-green-style" value="CONTINUE" onclick="callOrderPage();" />
                    ...
                    <tr>
                      <td><table width="680" border="0" cellspacing="0" cellpadding="0">
                        <tr style="display:none;">
                          <td width="430">&nbsp;</td>
                            <td>&nbsp;</td>
                            <td width="250" style="display:none;"><input name="createrecord" type="submit" class="clk_button_01" id="createrecord" value="UPDATE ITEM" />
                                <input name="button" type="reset" class="settingsbutton_gray" id="button" style="display:none;" value="CLEAR FORM" /></td>
                          </tr>
