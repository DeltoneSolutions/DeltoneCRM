<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addpromotionalitem.aspx.cs" Inherits="DeltoneCRM.Manage.addpromotionalitem" %>
      ...
      $(document).ready(function () {
          ...
          $("#<%=form1.ClientID%>").validate({
              ...
              submitHandler: function(form) {
                  $.post("Process/Process_AddPromotialItem.aspx",
                      {
                          NewItem: $('#NewItem').val(),
                          NewCost: $('#NewCost').val(),
                      ...
                      function (data, status) {
                          if (Number(data) > 0) {
                              alert('Promotional Item has been created successfully');
                            ...
                            <tr>
                              <td width="315"><table width="315" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td width="215"><input name="NewDefaultQty" type="text" class="txtbox-200-style-edit" id="NewDefaultQty" /></td>
                                </tr>
                              </table></td>
                              <td width="20">&nbsp;</td>
                              <td width="315"><table width="315" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td width="100" class="labels-style">SHIPPING $</td>
                                  <td width="200"><input name="NewShippingCost" type="text" class="txtbox-200-style-edit" id="NewShippingCost" /></td>
                                </tr>
                              </table></td>
                            </tr>
                          </table></td>
