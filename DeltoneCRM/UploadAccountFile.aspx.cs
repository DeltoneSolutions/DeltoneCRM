...
{
    public partial class UploadAccountFile : System.Web.UI.Page
    {
        ...
        protected void UploadFile(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < fileCollection.Count; i++)
            {
                ...
                var filDirctory = Server.MapPath("~/CompanyUploads/Companies/" + str_AccountID + "/");
        ...
        protected void LoadUploadedFiles()
        {
            ...
            if (Directory.Exists(Server.MapPath("~/CompanyUploads/Companies/" + str_AccountID)))
            {
                string[] filePaths = Directory.GetFiles(Server.MapPath("~/CompanyUploads/Companies/" + str_AccountID));
        ...
        protected void OpenTab(object sender, EventArgs e)
        {
            ...
            var domainNameWithFile = "http://localhost:65085//CompanyUploads/Companies/";
            var domainNameWithFileServer = "http://delcrm//CompanyUploads/Companies/";

            var filePathWithDomain = domainNameWithFileServer + str_AccountID + "/" + filePathOri;
