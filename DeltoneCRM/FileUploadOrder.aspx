<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FileUploadOrder.aspx.cs" Inherits="DeltoneCRM.FileUploadOrder" %>
    ...
    <script>
        ...
        function handleDnDFileSelect(event) {
            ...
            if (s != null) {
                ...
                xhr.open('POST', "FileUploadOrder.aspx?ordID=" + orderIdQuery);
    ...
    <div>
        ...
        <div > 
            <table>
                <tr> 
                    <td>
            <asp:Button ID="ButtonChangeCompleted" runat="server" Text="Revert To Approved" Visible="false"  OnClick="completedToApproved" CausesValidation="false" CssClass="buttonClass btnsty"/> 
         <asp:Button ID="completeButton" runat="server" Text="All Files Uploaded"  OnClick="changeOrder_click" CausesValidation="false" CssClass="buttonClass btnsty "/> 
            <asp:Button ID="ButtonApproveOrderPurchase" runat="server" Text="Authorize Purchase and Create A Bill"  Visible="false" CausesValidation="false"
                OnClick="ButtonApproveOrderPurchase_click" CssClass="buttonClass btnsty "/> 
