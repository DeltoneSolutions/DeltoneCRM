...
{
    public partial class FileUploadOrder : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (y == "Y")
            {
                ...
                ButtonChangeCompleted.Visible = true;
        ...
        protected void ButtonCreateBill_click(object sender, EventArgs e)
        {
            ...
            if (purchasedXeroINfo.Count() > 0)
            {
                ...
                CreateAuditRecord("Purchase Order Billed", "Billed", "APPROVED");
        ...
        protected void ButtonApproveOrderPurchase_click(object sender, EventArgs e)
        {
            ...
            if (purchasedXeroINfo.Count() > 0)
            {
                ...
                CreateAuditRecord("Purchase Order Approved", " Draft to Authorised", "APPROVED");
                xero.ChangeStatusPurchaseOrderBilled(purchasedXeroINfo);
                CreateAuditRecord("Purchase Order Billed", " Authorised to Billed", "APPROVED");
        ...
        {
            updateOrderStatus();
            CreateAuditRecord("COMPLETED", "APPROVED to COMPLETED", "APPROVED");
            messagelable.Text = "Successfully Updated";
        ...
        private void CreateAuditRecord(string stsMessage, string endmessage, string preVale)
        {
        ...
        protected void completedToApproved(object sender, EventArgs e)
        {
            updateOrderStatusBackToApproved();
            CreateAuditRecord("APPROVED", "COMPLETED to APPROVED", "COMPLETED");
            messagelable.Text = "Successfully Updated To APPROVED";
            ButtonApproveOrderPurchase.Visible = false;
            ButtonChangeCompleted.Visible = false;
        }

        protected int updateOrderStatusBackToApproved()
        {
