<%@ Page Title="" Language="C#" ValidateRequest="false"  MasterPageFile="~/NoNav.Master" AutoEventWireup="true" CodeBehind="Quote.aspx.cs" Inherits="DeltoneCRM.Quote" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#addnewitem').click(function () {
                ...
                if (!($('#ItemDesc').val() == '')) {
                    var $row = $('<tr class="item-row"><td class="tbl-auto-row-01-btm"><a class="delete" title="Remove row"><img src="Images/x.png" width="16" height="16" /></a></td><td class="tbl-auto-row-02-btm"><label for="ItemDesc"></label><input name="ItemDesc" type="text" class="tbl-auto-row-02-inside" id="ItemDesc" onkeydown = "return (event.keyCode!=13);"></td><td class="tbl-auto-row-03-btm"><label for="suppliercode"><input name="ItemType" type="text" class="tbl-auto-row-03-inside" id="ItemType" onkeydown = "return (event.keyCode!=13);"></td><td class="tbl-auto-row-04-btm"><label for="suppliercode"></label><input name="suppliercode" type="text" class="tbl-auto-row-04-inside" id="suppliercode" onkeydown = "return (event.keyCode!=13);"></td><td class="tbl-auto-row-05-btm"><label for="COG"></label><input name="COG" type="text" class="tbl-auto-row-05-inside" id="COG" onkeydown = "return (event.keyCode!=13);"></td><td class="tbl-auto-row-06-btm"><label for="qty"></label><input name="qty" type="text" class="tbl-auto-row-06-inside" id="qty" onkeydown = "return (event.keyCode!=13);"></td><td class="tbl-auto-row-07-btm"><label for="UnitPrice"></label><input name="UnitPrice" type="text" class="tbl-auto-row-07-inside" id="UnitPrice" onkeydown = "return (event.keyCode!=13);"></td><td align="right" class="tbl-auto-row-08-btm"><span class="total">$00.00</span></td><td align="right" class="tbl-auto-row-09-btm"><span class="cogtotal">$00.00</span><label for="hidden_item_code"></label><input name="hidden_item_code" type="text" id="hidden_item_code" size="1" hidden="hidden"/><input type="hidden" name="hidden_Supplier_Name" id="hidden_Supplier_Name"  value="" /></td></tr>').insertAfter(".item-row:last");
                    bind($row);
                }
                else {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <asp:ScriptManager ID="ScriptManagerQuotes111111" runat="server" EnablePageMethods="true">
    </asp:ScriptManager>
      ...
      <table align="center" cellpadding="0" cellspacing="0" class="btm_01">
            ...
            <td height="25px">
               ...
               <%-- <asp:Button OnClick="btnnewquote_Click" ID="NewQuoteButton" Text="NEW QUOTE" ForeColor="Blue" Width="10%"
                ...
                <asp:Button OnClick="btnupload_Click" ID="btnDashboard" Text="DASHBOARD" ForeColor="Blue" Width="10%"
                    runat="server" CssClass="buttonClass moverigRight" CausesValidation="false" />
                  <asp:Button OnClick="btnaccountCompany_Click" ID="ButtonaccCompa" Text="Account" ForeColor="Blue" Width="10%" Visible="false"
                    runat="server" CssClass="buttonClass moverigRight" CausesValidation="false" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td id="OrderTitle" runat="server" class="all-headings-style" >NEW QUOTE</td>
        ...
        <tr>
            <td height="20px" class="white-bg-style">
                <table align="center" cellpadding="0" cellspacing="0" class="width-940-style">
                    ...
                    <tr>
                        <td>
                            <input type="button" value="QUOTES" style="width:200px;color:white;background-color:blue;height:37px;" onclick="callEmailHeader('1');"/> 
                            <input type="button" value="CONFIRMATION OF ORDER" style="width:200px;color:white;background-color:red;height:37px;" onclick="callEmailHeader('2');"/>
                            <input type="button" value="Third" style="width:200px;color:black;background-color:yellow;height:37px;display:none;" onclick="callEmailHeader('3');"/>
                            <input type="button" value="Fouth" style="width:200px;color:white;background-color:green;height:37px;display:none;" onclick="callEmailHeader('4');"/>
                        </td>
                    </tr>
                    <tr>
                        <td>
...
<td class="tbl-auto-row-01">&nbsp;</td>
              <td class="tbl-auto-row-02"><label for="ItemDesc"></label>
                <input name="ItemDesc" type="text" class="tbl-auto-row-02-inside" id="ItemDesc" onkeydown = "return (event.keyCode!=13);"></td>
              <td class="tbl-auto-row-03"><label for="suppliercode">
                <input name="ItemType" type="text" class="tbl-auto-row-03-inside" id="ItemType" onkeydown = "return (event.keyCode!=13);"></td>
              <td class="tbl-auto-row-04"><label for="suppliercode"></label>
                <input name="suppliercode" type="text" class="tbl-auto-row-04-inside" id="suppliercode" onkeydown = "return (event.keyCode!=13);"></td>
              <td class="tbl-auto-row-05"><label for="COG"></label>
                <input name="COG" type="text" class="tbl-auto-row-05-inside" id="COG" onkeydown = "return (event.keyCode!=13);"></td>
              <td class="tbl-auto-row-06"><label for="qty"></label>
                <input name="qty" type="text" class="tbl-auto-row-06-inside" id="qty" onkeydown = "return (event.keyCode!=13);"></td>
              <td class="tbl-auto-row-07"><label for="UnitPrice"></label>
                <input name="UnitPrice" type="text" class="tbl-auto-row-07-inside" id="UnitPrice" onkeydown = "return (event.keyCode!=13);"></td>
                ...
                <table align="center" cellpadding="0" cellspacing="0" class="width-940-style">
                    ...
                    <tr>
                        <td>
                                     ...
                                     <asp:TextBox ID="TextBoxNoteAllocatedQuote" TextMode="multiline" class="notes-textbox-style" runat="server"></asp:TextBox>

                                 </td>
                    </tr>
                    <tr>
                        <td> <input type="button" value="Save Notes" style="width:120px;border: 1.0px solid red;background-color: white;cursor: pointer;" onclick="return SaveMe();" /> </td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <tr>
             ...
             <tr>
                 ...
                 <td >
                                        ...
                                        `</td> 
                 <td><input type="button" id="btnPrintOrderrefresh" name="btnPrintOrder"  value="RELOAD QUOTE" onclick="RefreshPage();" /></td>
             </tr>
 ...
 <option value="ACT" >    ACT     </option> 
   ...
   <iframe id="addcontactiframe" width="950" height="700"style="border:0px;"></iframe>   
    ...
    <script type="text/javascript">
        ...
        var twdsimagepathUrl = "UploadQuoteImage.aspx";

        function getTextEditorContyent() {

            var content = tinyMCE.get("txt_EmailHeader").getContent({ format: 'raw' });
        }
        ...
        $(document).ready(function () {
            ...
            var comId = getParameterByName("CompID");
            if (quoteId)
                twdsimagepathUrl = "UploadQuoteImage.aspx?comId=" + comId + "&quoteId=" + quoteId;
            else
                twdsimagepathUrl = "UploadQuoteImage.aspx?comId=" + comId + "&quoteId=" + " ";
                ...
                buttons: {
                    "Add": function () {
                        ...
                        if (comId) {
                                ...
                                comId=  getParameterByName("CompID");
                            }
                        ...
                        if (validateInput()) {
                           ...
                           // if (aaa)
                                PageMethods.addEvent(eventToAdd, isEventSave, addSuccess);
                            //else {

                            //    $.ajax({
                            //        type: "POST",
                            //        url: "Process/ProcessScheduleEventQuote.aspx",
                            //        data: {
                            //            title: $("#addEventName").val(),
                            //            description: $("#addEventDesc").val(),
                            //            start: $("#addEventStartDate").val(),
    ...
    <style type="text/css">
        ...
        body {
            /*background-color: #34c623 !important;*/
