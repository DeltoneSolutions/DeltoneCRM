...
{
    /// <summary>
    /// Summary description for PendingQuotesDataHandler
    /// </summary>
    public class PendingQuotesDataHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("getAllPendingQuotes", conn);
        ...
        private int getItemsTotalCount()
        {
            ...
            using (SqlConnection conn = new SqlConnection(cs))
            {
                SqlCommand cmd = new SqlCommand("SELECT COUNT(*) FROM dbo.Quote WHERE Status = 'PENDING' AND Flag = 'LiveDB'", conn);
                conn.Open();
