...
{
    /// <summary>
    /// Summary description for LiveDBQuotesDataHandler
    /// </summary>
    public class LiveDBQuotesDataHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("getAllActiveQuotes", conn);
        ...
        private int getItemsTotalCount()
        {
            ...
            using (SqlConnection conn = new SqlConnection(cs))
            {
                SqlCommand cmd = new SqlCommand("SELECT COUNT(*) FROM dbo.Quote WHERE Status = 'ACTIVE' AND Flag = 'LiveDB'", conn);
                conn.Open();
