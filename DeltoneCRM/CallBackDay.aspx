<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CallBackDay.aspx.cs" MasterPageFile="~/NoNav.Master" Inherits="DeltoneCRM.CallBackDay" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function callMe() {
            var se = $("#MonthSelect").val();
            var ye = $("#YEARSelect").val();
            CreateTableData(se, ye);
        }


        function CreateTableData(re, ye) {
            var catValue = "a";
            if (table)
                table.destroy();
            ...
            table = $('#noordercompany').DataTable({
                ...
                "ajax": "../Fetch/FetchCallbackData.aspx?n=1",
                "columnDefs": [
                        {
            ...
            <table width="1200" border="0" align="center" cellpadding="0" cellspacing="0" class="MainTable">
                ...
                <tr>
                    <td height="25px">
                       ...
                       <select id="MonthSelect" style="width:300px;height:30px;">
 ...
 <option value="2" >  FEB         </option>
                 ...
                 <tr>
                    <td height="25px">
                       ...
                       <select id="YEARSelect" style="width:300px;height:30px;">
 ...
 <option value="2019" >  2019         </option>
                ...
                <tr>
                    ...
                    <td height="25px">
                        ...
                        <input type="button" id="viewcallback"  value="VIEW" onclick="callcallbackData();" 
        ...
        <div id="maindatatableMain">
            <br />
                ...
                <tr>
                    <td height="25px" class="section_headings">CALLBACK EVENTS</td>
                </tr>
