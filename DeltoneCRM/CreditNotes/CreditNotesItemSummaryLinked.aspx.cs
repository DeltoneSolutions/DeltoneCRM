...
{
    public partial class CreditNotesItemSummaryLinked : System.Web.UI.Page
    {
        ...
        protected void getCustomerDetails(string comId)
        {
            ...
            using (SqlConnection sqlConn = new SqlConnection())
            {
                ...
                {
                    cmd.CommandText = "SELECT CT.*, CP.CompanyName FROM dbo.Contacts CT, dbo.Companies CP WHERE CT.CompanyID = CP.CompanyID AND CP.CompanyID = " + comId;
