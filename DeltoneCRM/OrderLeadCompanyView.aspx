<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderLeadCompanyView.aspx.cs" Inherits="DeltoneCRM.OrderLeadCompanyView" MasterPageFile="~/NoNav.Master"%>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td width="150px" class="align-vertical">
                                        <table align="center" cellpadding="0" cellspacing="0" class="auto-style5">
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="button" value="Save Status" onclick="return updateCalledStatus();"  class="submit-btn"/>
                                                </td>
                                            </tr>
    ...
    <script type="text/javascript">
        ...
        function updateCalledStatus() {
            ...
            var statusSelection = $("#calledstatusselect").val();
                $.ajax({
                    url: "process/ProcessleadcomanyStatus.aspx",
                    data: {
