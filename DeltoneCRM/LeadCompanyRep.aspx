<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeadCompanyRep.aspx.cs" MasterPageFile="~/SiteInternalNavLevel1.Master" Inherits="DeltoneCRM.LeadCompanyRep" %>
    ...
    function () {
        ...
        function CreateTableData(){
            ...
            table = $('#noordercompany').DataTable({
                ...
                "ajax": "../Fetch/FetchLeadRepCompany.aspx",
                columns: [
                     {
