<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/NoNav.Master" CodeBehind="coldiesStatus.aspx.cs" Inherits="DeltoneCRM.coldiesStatus" %>
                ...
                success: function (data) {
                    ...
                    $.each(result, function (index, value) {
                        ...
                        if (splitdata[1] == "3") {
                            ...
                            var dailyComMangager = parseFloat(splitdata[3].replace('$ ', ''));
                            var monthComManager = parseFloat(splitdata[4].replace('$ ', ''));
                            var calculatedailyCom = parseFloat(dailyComMangager / .1 - 165.68).toFixed(2);
                            var calculateMonCom = parseFloat(monthComManager / .1 - 165.68).toFixed(2);
                  ...
                  //  $("#stattable").append(rowManagers);
                    ...
                    $('#divnosales').html(totalSalesColdies);
                    $('#divdailycomm').html("$ " + parseFloat(totalDailyCommColdies).toFixed(2));
                    $('#divmonthcomm').html("$ " + parseFloat(totalMonComColdies).toFixed(2));
                    $('#divreqdaily').html("$ " + parseFloat(totalRequiredDailyColdies).toFixed(2));
                    $('#divbudget').html("$ " + parseFloat(totalBudgetColdies).toFixed(2));
                    $('#divnewaccounts').html(totalNewAcctColdies);
                    $('#divdailyvol').html("$ " + parseFloat(totaldailyVolColdies).toFixed(2));
                    $('#divmonthvol').html("$ " + parseFloat(totalMonVolColdies).toFixed(2));

                    $('#divdailycommcal').html("$ " + parseFloat(totalcallmanagers).toFixed(2));
                    $('#divmonthcommcal').html("$ " + parseFloat(totalmonthlycommcalmanager).toFixed(2));
