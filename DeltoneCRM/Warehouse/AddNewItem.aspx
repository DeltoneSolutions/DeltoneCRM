<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddNewItem.aspx.cs" Inherits="DeltoneCRM.Warehouse.AddNewItem" %>
   ...
   <td><table width="650" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <td width="315"><table width="315" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td width="100" class="labels-style">Active&nbsp;</td>
                                  <td width="215">  <input name="itemactivestat" type="checkbox" class="txtbox-200-style-edit" id="itemactivestat" /></td>
    ...
    <script type="text/javascript">
        ...
        function createMainObject() {
            ...
            if ($("#itemactivestat").is(':checked'))
                mainDisplayWShelfItemDetails.ActiveSts = true;
        ...
        function submitItemsData() {
                ...
                $("#<%=form1.ClientID%>").validate({
                    ...
                    submitHandler: function (form) {
                        $.ajax({
                            type: "POST",
                            url: "Process/addshelfitems.aspx",
        ...
        function loadShelfItems() {
            ...
            if (selectedShelId != "") {
                ...
                $.ajax({
                    type: "POST",
                    url: "Fetch/fetcheditShelfItems.aspx",
                    data: JSON.stringify(selectedShelId),
                    success: function (msg) {
        ...
        function setLoadedValues(dataEdit) {
            ...
            $("#itemactivestat").prop('checked', dataEdit.ActiveSts);
