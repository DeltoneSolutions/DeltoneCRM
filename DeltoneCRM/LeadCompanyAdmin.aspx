<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeadCompanyAdmin.aspx.cs" MasterPageFile="~/NoNav.Master" Inherits="DeltoneCRM.LeadCompanyAdmin" %>
    ...
    <script type="text/javascript">
        ...
        function CreateTableData(re) {
            ...
            table = $('#noordercompany').DataTable({
                ...
                "ajax": "../Fetch/FetchLeadCompanyByRep.aspx?n=1",
                "columnDefs": [
                        {
    ...
    <div id="gridDiv">
            ...
            <table width="1200" border="0" align="center" cellpadding="0" cellspacing="0" class="MainTable">
                ...
                <tr>
                    ...
                    <td height="25px">
                        ...
                        <asp:Button ID="allocateRepButton" runat="server" Text="ALLOCATE" OnClick="btn_allocate_Click" OnClientClick="javascript:ShowProgressBar()"
        ...
        <img src="/images/loadingimage1.gif" /> <strong style="color:red;">  Updating, Please Wait...</strong>
                ...
                <tr style="display: none;">
                    <td class="white-box-outline">
                        ...
                        <asp:GridView ID="GridView1LeadAdmin" runat="server" AllowPaging="true" PageSize="60" OnPageIndexChanging="GridView1_PageIndexChanging"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Contact Name" SortExpression="ContactName">
                                    <ItemTemplate>
                                        <asp:Label ID="Labelcontact" runat="server" Text='<%# Eval("ContactName") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Rep" SortExpression="Hold">
                                    <ItemTemplate>
                                        <asp:Label ID="LabelRep" runat="server" Text='<%# Eval("RepName") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
        ...
        <div id="maindatatableMain">
            <br />
                ...
                <tr>
                    <td height="25px" class="section_headings">LEADS</td>
                </tr>
