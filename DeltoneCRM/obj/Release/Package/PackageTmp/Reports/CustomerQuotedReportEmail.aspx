<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerQuotedReportEmail.aspx.cs" ValidateRequest="false"
    MasterPageFile="~/NoNav.Master"  Inherits="DeltoneCRM.Reports.CustomerQuotedReportEmail" %>
        ...
        $(function () {
            $('#<%=searchTextBox.ClientID%>').autocomplete({
                source: function (request, response) {
                    $.ajax({
                        type: "POST",
                        url: "CustomerQuotedReportEmail.aspx/GetProductCode",
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ScriptManager ID="ScriptManagerProCodeQuotedSearch" runat="server" EnablePageMethods="true">
    </asp:ScriptManager>
    <div style="text-align:center">

        <h1 style="align-content: center">Search Customer By Quoted Product</h1>
    </div>
    ...
    <div>
        ...
        <asp:Button OnClick="reloadPage" ID="btnreset" Text="Reset" ForeColor="Blue" Width="10%" runat="server" CausesValidation="false" />
        ...
        <br />
            ...
            <tr>
                <td colspan="2">
                    <asp:GridView ID="GridViewProduct" runat="server" AllowPaging="true" PageSize="35" OnSorting="gridView_Sorting" AllowSorting="true"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Company" SortExpression="CompanyName">
                                <ItemTemplate>
                                    ...
                                    <asp:HiddenField ID="emailval" runat="server" Value='<%# Eval("Email") %>' />
                                     <asp:HiddenField ID="firstname" runat="server" Value='<%# Eval("contactFirstName") %>' />
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Email" SortExpression="tlenumber">
                                <ItemTemplate>
                                    <asp:Label ID="tlenumber" runat="server" Text='<%# Eval("Email") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Quote Id" SortExpression="OrderID">
                                <ItemTemplate>
                                    <asp:Label ID="OrderID" runat="server" Text='<%# Eval("OrderID") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Quoted Date" SortExpression="CreatedDateTime">
                                <ItemTemplate>
