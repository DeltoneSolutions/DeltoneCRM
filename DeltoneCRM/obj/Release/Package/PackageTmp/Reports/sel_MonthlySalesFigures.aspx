<%@ Page Title="" Language="C#" MasterPageFile="~/NoNav.Master" AutoEventWireup="true" CodeBehind="sel_MonthlySalesFigures.aspx.cs" Inherits="DeltoneCRM.Reports.sel_MonthlySalesFigures" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table width="980" border="0" align="center" cellpadding="0" cellspacing="0" class="MainTable">
        ...
        <tr>
          <td height="25px" class="section_headings">Monthly Sales Figures</td>
        </tr>
