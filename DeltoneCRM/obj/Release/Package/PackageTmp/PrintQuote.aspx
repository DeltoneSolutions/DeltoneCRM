<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintQuote.aspx.cs" Inherits="DeltoneCRM.PrintQuote" %>
                    ...
                    <tr>
                        ...
                        <td width="250px" style="vertical-align: top;">
                            <table align="center" cellpadding="0" cellspacing="0" class="width-250-style">
                                ...
                                <tr>
                                    <td class="top-box-style" height="100px"><img src="Images/quote.jpg" alt="Quote Only" width="75%" height="75%" /></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                </tr>
            ...
            <td><div id="DeliveryCompany" runat="server"></div></td>
                    ...
                    <tr>
                        <td>
                            <table align="center" cellpadding="0" cellspacing="0" class="width-940-style">
                                <tr>
                                    <td class="top-tbl01-style">QUOTE CREATED DATE</td>
                                    <td class="top-tbl01-style">&nbsp;</td>
                                    <td class="top-tbl02-style">&nbsp;</td>
                                    <td class="top-tbl02-style">&nbsp;</td>
                                    <td class="top-tbl02-style">QUOTE CREATED BY</td>
                                    <td class="top-tbl02-style">&nbsp;</td>
                                </tr>
                                <tr>
