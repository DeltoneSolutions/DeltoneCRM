<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderNoExistsCompanyView.aspx.cs" Inherits="DeltoneCRM.OrderNoExistsCompanyView" MasterPageFile="~/NoNav.Master"%>
...
<asp:Content ID="MainHeader" ContentPlaceHolderID="head" runat="server">
                ...
                for (k = 0; k < arr_Suppliers.length; k++) {
                    if (arr_Suppliers[k] != '') {
                        if (IsSupplierExsists(arr_Suppliers[k]) > 0) {
                            var RowDelCost = 10;                                      // default value for supplier del cost
                            var RowDelRealCost = 10;
    ...
    function callCommission(ProfitSubTotalExGST) {
        ...
        function setRealCostDelivery() {
            ...
            lineprofittotal = lineprofittotal + newdelValue + adjValue;
...
<asp:Content ID="MainContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <td>
                ...
                <table align="center" cellpadding="0" cellspacing="0" class="width-980-style">
                    ...
                    <tr style="color:white !important;">
                        <td id="OrderTitle" runat="server" class="all-headings-style" style="display: none;color:white;"><span style="color:white;">NEW ORDER </span> </td>
                                ...
                                <tr>
                                    ...
                                    <td width="150px" class="align-vertical">
                                        <table align="center" cellpadding="0" cellspacing="0" class="auto-style5">
                                            ...
                                            <tr style="display:none;">
                                              <td> 
                                                <select id="calledstatusselect" style="width: 150px;">
                                            ...
                                            <tr>
                                                <td style="display:block;">
                                                    <input type="button" value="Sold" onclick="return updateCalledStatus();"  class="submit-btn"/>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="display:none;">
                                                    ...
                                                    <br />
                                                    <br />
                                                    <td style="display:none;">  <asp:Button ID="ButtonCreate" runat="server" Visible="false" OnClientClick="return openDialogCs();" class="submit-btn" Text=" Raise CS" /> </td>
    ...
    <tr id="TR_singlecommission" runat="server">
        <td>
            <table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr >
                    <td width="748" class="comm-01-style"><span id="accountowner" style="display:none;"></span>COMMISSION</td>
    ...
    <tr id="TR_SplitCommission" runat="server">
        <td>
            <table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr >
                    <td width="748" class="comm-01-style"><span id="salesperson" style="display:none;"></span>COMMISSION</td>
                    <td class="comm-02-style">
    ...
    <tr>
        <td class="white-bg-style" style="display: none;">
            <table align="center" cellpadding="0" cellspacing="0" class="width-940-style">
                <tr>
                    <td>&nbsp;</td>
                </tr>
    ...
    <tr id="TRWarningBeforeSubmit" runat="server">
        <td class="warning_before_submit" style="display:none;">PLEASE NOTE THAT THE SALESPERSON AND ACCOUNT OWNER ARE NOT THE SAME. IF THE COMMISSION IS TO BE SPLIT, PLEASE ENSURE THAT YOU HAVE TICKED THIS.</td>
    </tr>
    <tr>
        <td>&nbsp;</td>
    </tr>
    ...
    <table id="Table1" width="980" border="0" align="center" cellpadding="0" cellspacing="0" runat="server">
        ...
        <tr>
            <td class="white-bg-style" id="xerologsection" runat="server" style="display:none;">
                <table align="center" cellpadding="0" cellspacing="0" class="width-940-style">
                    <tr>
                        <td>&nbsp;</td>
                    </tr>
    ...
    <script type="text/javascript">
        ...
        function updateCalledStatus() {
            console.log('test');
            var comidQString = getParameterByName("Compid");
            var statusSelection = "Y";
                $.ajax({
                    url: "process/ProcessNotExistCompanyStatus.aspx",
                    data: {
                       
                        CompID: comidQString,
                        stat: statusSelection
                    },
