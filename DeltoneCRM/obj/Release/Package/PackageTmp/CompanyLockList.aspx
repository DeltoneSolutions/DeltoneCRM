<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyLockList.aspx.cs" MasterPageFile="~/NoNav.Master" Inherits="DeltoneCRM.CompanyLockList" %>
            ...
            <table width="1200" border="0" align="center" cellpadding="0" cellspacing="0" class="MainTable">
                ...
                <tr>
                    ...
                    <td height="25px">
                        ...
                        <input type="button"  id="allocateRepButton" value="UPDATE"  onclick="return callUpdateCompany()"
