<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyOrderItemSummary.aspx.cs"
     Inherits="DeltoneCRM.CompanyOrderItemSummary" MasterPageFile="~/SiteInternalNavLevel1.Master" %> 
...
<asp:Content ID="HeaderSection" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function orderTableGroup() {
            ...
            $('#noordercompanyhistory tbody').on('click', 'tr.group', function () {
        ...
        function CreateTableDataHistory(re) {
            ...
            table = $('#noordercompanyhistory').DataTable({
                processing: true,
                "language": {
                      ...
                      //  console.log("ccc" + i);
                        if (last !== group) {
                          ...
                          //  var urlLink = "order.aspx?dtId=" + group;
                            var buttonRow = '<td colspan="1" style="BACKGROUND-COLOR:rgb(183, 172, 168);font-weight:700;color:#3E3A42;" onclick="callMypage(' + idORder[i] + ');"> <a onclick="callMypage(' + group + ');" href="#"/>View</a></td>';
                            $(rows).eq(i).before(
        ...
        function callMypage(dttId) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    window.open("order.aspx?Oderid=" + dttId + "&cid=" + conId + "&Compid=" + comId, '_self');
        ...
        function CreateTableData(re) {
            ...
            tabletwo = $('#noordercompany').DataTable({
                processing: true,
                "language": {
                    "processing": '<img src="/images/loadingimage1.gif"> Hang on. Waiting for response...</img>' //add a loading image,simply putting <img src="loader.gif" /> tag.
                },
                ...
                drawCallback: function (settings) {
                    ...
                    api.column(1, { page: 'current' }).data().each(function (group, i) {
                        ...
                        if (last !== group) {
                            var buttonRow = '<td colspan="1" style="BACKGROUND-COLOR:rgb(183, 172, 168);font-weight:700;color:#3E3A42;" onclick="callMypageCredit(' + idcredit[i] + ');"> <a onclick="callMypage(' + group + ');" href="#"/>View</a></td>';
                            $(rows).eq(i).before(
                                '<tr class="group"><td colspan="7" style="BACKGROUND-COLOR:rgb(183, 172, 168);font-weight:700;color:#3E3A42;">' + 'CREDIT : ' + group + '</td>' + buttonRow + '</tr>'
                            );
        ...
        function callMypageCredit(dttId) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    conId = parseresult.ContactId;
                    comId = parseresult.CompanyId;
                    window.open("../UpdateCredit.aspx?CreditNoteID=" + dttId + "&cid=" + conId + "&Compid=" + comId, '_self');
...
<asp:Content ID="MainSection" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="gridDiv">
        ...
        <div id="maindatatableMain">
                ...
                <tr>
                    <td height="25px" class="section_headings">CREDIT ITEMS SUMMARY</td>
                </tr>
    ...
    <script type="text/javascript">
        ...
        function callUpdateCompany() {
            ...
            $("#noordercompanyhistory").find("input[name='selectchk']:checked").each(function (i, ob) {
        ...
        function getlockeCompanyStatus(comID) {
            var canFind = false;
            $("#noordercompanyhistory").find("input[name='selectlock']").each(function (i, ob) {
