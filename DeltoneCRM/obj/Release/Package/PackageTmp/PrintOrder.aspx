<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintOrder.aspx.cs" Inherits="DeltoneCRM.PrintOrder"%>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
                    ...
                    success: function (data) {
                      ...
                      //  alert(indidata);
                        if (indidata[0] != "0") {
                            ...
                            $('#accountowner').html(indidata[1].toUpperCase() + " - ");
                            $('#salesperson').html(indidata[2].toUpperCase() + " - ");
                        }
                        else {
                            $('#<%=TR_SplitCommission.ClientID%>').hide();
                        }
            ...
            function update_total() {
                ...
                if ($('#<%=SALESPERON_ID.ClientID%>').val() == "0") {
                    $.ajax({
   ...
   <table align="center" cellpadding="0" cellspacing="0" class="width-940-style">
        ...
        <tr>
            <td>
                <table align="center" cellpadding="0" cellspacing="0" class="width-940-style">
                    <tr>
                        <td id="OrderTitle" runat="server" class="all-headings-style"  style="display:none;">&nbsp;</td>
            ...
            <td><div id="DeliveryCompany" runat="server"></div></td>
                    ...
                    <tr>
                        <td>
                            <table align="center" cellpadding="0" cellspacing="0" class="width-940-style">
                                <tr>
                                    <td class="top-tbl01-style">ORDER CREATED DATE</td>
                                    <td class="top-tbl01-style">ORDER DATE</td>
                                    <td class="top-tbl02-style">CUSTOMER REFERENCE</td>
                                    <td class="top-tbl02-style">PAYMENT TERMS</td>
                                    <td class="top-tbl02-style">ORDER CREATED BY</td>
                                    <td class="top-tbl02-style">TYPE OF CALL</td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="top-tbl03-style">
                                        <div id="orderdatediv" runat="server"></div>
                                    </td>
                                    <td class="top-tbl04-style">
                                        <div id="custreferencediv" runat="server"></div>
                                    </td>
                                    <td class="top-tbl04-style">
                                        <div id="paymenttermsdiv" runat="server"></div>
                                    </td>
                                    <td class="top-tbl04-style">
                                        <div id="ordercreatedbydiv" runat="server"></div>
                                    </td>
                                    <td class="top-tbl04-style">
                                        <div id="typeofcalldiv" runat="server"></div>
                                    </td>
                                </tr>
                            </table>
                        </td>
...
<!-- <tr class="supp-del-row"><td class="tbl-delivery-04-outside"><input name="suppdeldet" type="text" class="tbl-delivery-04-inside" id="Text1"  disabled="disabled"></td><td class="tbl-delivery-05-outside"><input name="hidden_supp_delivery_item_id" type="text" id="Text2" size="1" hidden="hidden"/><input name="hdn_Supp_Name" type="text" id="Text3" size="1" hidden="hidden" />N/A</td><td class="tbl-delivery-06-outside"><input name="suppdelcost" type="text" class="tbl-delivery-06-inside" id="Text4"/></td>
                    ...
                    <tr>
                        <td>
                            ...
                            <tr style="display:none;" class="item-supprow">
                <td>
        ...
        <tr>
            <td class="white-bg-style">
                <table align="center" cellpadding="0" cellspacing="0" class="width-940-style">
                    ...
                    <tr>
                        <td class="auto-style11">Notes</td>
                    </tr>
                    <tr>
                        <td class="auto-style10">&nbsp;</td>
                    </tr>
...
<table id="Table1" width="940" border="0" align="center" cellpadding="0" cellspacing="0"   runat="server" >
        ...
        <tr hidden="hidden">
                <td height="20px">
                    ...
                    <input type="text" name="hdnLoggedUser" id="hdnLoggedUser" runat="server" />
                    AccountOwner
                    ...
                    IsCommishSplit
                    <input type="text" name="COMMISHSPLIT" id="COMMISHSPLIT" runat="server" />
                </td>
