<%@ Page Language="C#" AutoEventWireup="true"  CodeBehind="ConpanyInfo.aspx.cs" Inherits="DeltoneCRM.ConpanyInfo" MasterPageFile="~/BackButtonNav.Master" %>
    ...
    <script type="text/javascript">
       // $.ui = null;
        ...
        $(document).ready(function () {
            ...
            $('#DummyOrderList').dataTable({
                "ajax": "Fetch/FetchAllDummyOrdersForCompany.aspx?companyid=" + $('#<%=hdnCompany.ClientID%>').val(),
                "columnDefs": [
                    { className: 'align_left', "targets": [1, 2, 3, 4] },
                    { className: 'align_center', "targets": [0, 5, 6, 7, 8, 9,10] },
        ...
        function FillLinkedCompanies() {

            var linkTableComDatatable = $("#tbllinkCompanies").dataTable({

                "ajax": "Fetch/FetchLinkCompany.aspx?companyid=" + $('#<%=hdnCompany.ClientID%>').val(),
                "columnDefs": [
                 { className: 'align_left', "targets": [1, 2] }
        ...
        function FillLinkedAdminCompanies() {

            var linkTableComDatatable = $("#tbllinkCompaniesAdmin").dataTable({

                "ajax": "Fetch/FetchLinkCompanyAdmin.aspx?companyid=" + $('#<%=hdnCompany.ClientID%>').val(),
                "columnDefs": [
                 { className: 'align_left', "targets": [1, 2] }
        ...
        function callUpdateCompany() {
            selecteditems = [];
            var mainConId=  getParameterByName("companyid");

            $("#noordercompany").find("button[name='selectchk']").each(function (i, ob) {

                var comId = $(ob).attr('id');
               // console.log(comId);
          ...
          //  console.log(selecteditems);
            ...
            ShowProgressBar();
            PageMethods.UpdateCompany(selecteditems, mainConId, updateCompanyResult);
        ...
        function autoCompleteCompanySearchText() {
            ...
            $('#findcompanyLinkcustomer').autocomplete({
                ...
                select: function (event, ui) {
                    ...
                    var LinkLocked = "<button name='selectchk' id='" + ui.item.id + "'>Delete</button>";

                    tableLinkSet.row.add([
...
<asp:Content ID="TheMainSection" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <table align="center" cellpadding="0" cellspacing="0" class="width-980-style">
                    ...
                    <table id="titleheader" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="300" align="right">
                                <input id="btn_AddAlarm" type="button" value="ADD ALARM" class="AddAlarmBTN" style="margin-right:20px;" /> 
            ...
            <tr id="alarmlist">
             ...
             <tr id="addlinkcompany" style="display:none;">
                <td>
                    <table id="addlinkcompanytable" cellspacing="0" cellpadding="0" width="980" class="table_overall">
                        <tr>
                            <td class="table_overall_heading" colspan="6">Add Company Link</td>
                        </tr>
                        <tr>
                       
                                    <td >        <input name="findcompanyLinkcustomer" type="text" class="main-search-style" id="findcompanyLinkcustomer" size="60" /></td>
                        ...
                        <tr><td><input type="button" value="Add" style="width:80px;" onclick="callUpdateCompany();"/> 
        ...
        <img src="/images/loadingimage1.gif" /> <strong style="color:red;">  Updating, Please Wait...</strong>
            ...
            <tr id="linkCompanyTr" >
                ...
                <tr >
                    <td class="section_headings">Linked Companies
                     <input type="button" onclick="showSummarylinked();" value="SUMMARY"
                ...
                <tr >
                    <td class="white-box-outline">
                        <table align="center" cellpadding="0" cellspacing="0" class="width-940-style">
                            ...
                            <tr>
                                <td id="usertrlink" style="display:none;">
                                    <table class="display" id="tbllinkCompanies" >
                                        <thead>
                                            <tr>
                                                <th>Id</th>
                                                <th>Company Name</th>
                                 ...
                                 <td id="admintrlink" style="display:none;">
                                     <table class="display" id="tbllinkCompaniesAdmin"">
                                        <thead>
                                            <tr>
                                                <th>Id</th>
                                                <th>Company Name</th>
 ...
 <tr>
    ...
    width: 950px;word-wrap:break-word;display:inline-block;"></div>
            ...
            <tr>
                <td class="section_headings">PAST ORDERS LIST
                    <input type="button" onclick="showSummary();" value="SUMMARY"
                        style="float: right; color: blue; font-weight: bold; cursor: pointer; width: 180px;" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="section_headings">CREDIT NOTE LIST
                     <input type="button" onclick="showCreditSummary();" value="SUMMARY"
                        style="float: right; color: blue; font-weight: bold; cursor: pointer; width: 180px;" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="section_headings">DUMMY ORDERS LIST
                    <input type="button" onclick="showSummary();" value="SUMMARY"
                        style="float: right; color: blue; font-weight: bold; cursor: pointer; width: 180px;display:none;" />
                </td>
            </tr>
            <tr>
                <td class="auto-style1">
                    <table align="center" cellpadding="0" cellspacing="0" class="width-940-style">
                        ...
                        <tr>
                            <td>
                                ...
                                <table class="display" id="DummyOrderList">
                                    <thead>
                                        <tr>
                                            <th>ORDER ID</th>
                                            <th>ORDER NAME</th>
 ...
 <option value="ACT" >    ACT     </option> 
    ...
    <script type="text/javascript">
        ...
        var r = confirm("Do you want to hide this record?");
        if (r == true) {
            PageMethods.UpdateContactStats(contactId, conhidestatus);
        }
        }

        function conhidestatus(addResult) {

            alert("Name Successfully hidden.");
            location.reload();
        }
