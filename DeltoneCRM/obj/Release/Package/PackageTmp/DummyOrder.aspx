<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DummyOrder.aspx.cs" Inherits="DeltoneCRM.DummyOrder" MasterPageFile="~/NoNav.Master" %>
        ...
        $(document).ready(function () {
            ...
            if ($('#<%=hdnORDERID.ClientID%>').val() == '') {
                $.ajax({
                    ...
                    success: function (data) {
                        if ($.trim(data) == 'VIC' || $.trim(data) == 'TAS' || $.trim(data) == 'QLD' || $.trim(data) == 'NSW' || $.trim(data) == 'ACT') {
                                var date_overdue = add_business_days(3);
                                var day = ("0" + date_overdue.getDate()).slice(-2);
                                var month = ("0" + (date_overdue.getMonth() + 1)).slice(-2);

                                var today = date_overdue.getFullYear() + "-" + (month) + "-" + (day);
                                var LDOM = new Date();
                                var lastdayofmonth = new Date(LDOM.getFullYear(), LDOM.getMonth() + 1, 0);
                                if (date_overdue > lastdayofmonth) {
                                    //alert('Current date of over the last month');
                                }
                                else {
                                    //alert('Still valid');
                                }
                        ...
                        else if ($.trim(data) == 'NT' || $.trim(data) == 'WA' || $.trim(data) == 'SA') {
                            var date_overdue = add_business_days(4);
                            var day = ("0" + date_overdue.getDate()).slice(-2);
                            var month = ("0" + (date_overdue.getMonth() + 1)).slice(-2);
...
<asp:Content ID="MainContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" >
    ...
    <div id="mainBody" style="background-color:#D3D3D3;">
 ...
 <tr>
            <td><label>Order Name:</label> <asp:TextBox ID="orderNameTextBox" runat="server" Width="420px"></asp:TextBox> </td>
        </tr>
                    ...
                    <tr>
                        ...
                        <td width="150px" class="align-vertical">
                            <table align="center" cellpadding="0" cellspacing="0" class="auto-style5">
                                ...
                                <tr>
                                    <td class="top-payment-terms-heading">
                                        &nbsp; URGENCY&nbsp;</td>
                                </tr>
                                ...
                                <tr>
                                    <td height="16px">
                                        <asp:DropDownList ID="ddl_Urgency" runat="server" CssClass="account-owner-drop">
                                            ...
                                            <asp:ListItem Text="Standard" Value="Standard" Selected></asp:ListItem>
                                ...
                                <tr>
                                    <td height="16px">
                                        <asp:CheckBox ID="TCKCreateCSV" runat="server" Text="Write into CSV file" Checked="false" />
                                    </td>
                                </tr>
                                ...
                                <tr id="splitcommissionpanel3" runat="server">
                                    <td height="16px">
                                        <asp:DropDownList ID="splitcommissionwith" runat="server" CssClass="account-owner-drop" AutoPostBack="true" OnSelectedIndexChanged="SplitWithChange">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
...
<td class="tbl-auto-row-01">&nbsp;</td>
              ...
              <td class="tbl-auto-row-04"><label for="suppliercode"></label>
                ...
                <td class="tbl-auto-row-10" style="text-align:center;"><label for="bestprice"></label>
                ...
                <td class="tbl-auto-row-10"><label for="cartfaulty"></label>
...
&nbsp;</td>
        ...
        <tr id="TR_SplitCommission" runat="server">
            <td><table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <td class="comm-02-style"><div id="DIV_SplitCommission">$00.00</div></td>
              </tr>
    ...
    <tr id="TRWarningBeforeSubmit" runat="server" style="display:none;">
    ...
    <tr>
        ...
        <tr >
            <td class="align_right">
                ...
                <input type="button" id="btnCancelInvoice" name="btnCancelInvoice" value="CANCEL ORDER" class="submit-btn" style="display:none;" runat="server" /></div>
            </td>
        </tr>
...
<table id="Table1" width="980" border="0" align="center" cellpadding="0" cellspacing="0"   runat="server" >
    ...
    <!-- SHOW UPLOADED FILES -->
    <tr id="FileUploadTR" runat="server" style="display:none;">
        <td>
