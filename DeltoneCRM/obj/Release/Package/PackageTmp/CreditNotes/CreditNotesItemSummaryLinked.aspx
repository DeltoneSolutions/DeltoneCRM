<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreditNotesItemSummaryLinked.aspx.cs"  MasterPageFile="~/SiteInternalNavLevel1.Master" Inherits="DeltoneCRM.CreditNotes.CreditNotesItemSummaryLinked" %>
    ...
    <script type="text/javascript">
        ...
        function CreateTableData(re) {
            ...
            table = $('#noordercompany').DataTable({
                ...
                "ajax": "../Fetch/FetchCompanyCreditItemsLinked.aspx?n=1",
                ...
                drawCallback: function (settings) {
                    ...
                    api.column(10, { page: 'current' }).data().each(function (namcoa, i) {

                        NameArray.push(namcoa);
                    ...
                    api.column(1, { page: 'current' }).data().each(function (group, i) {
                        ...
                        if (last !== group) {
                            if (typeArray[i] == "3") {
                                ...
                                $(rows).eq(i).before(
                                    '<tr class="group"><td colspan="7" style="BACKGROUND-COLOR:rgb(0, 102, 255);font-weight:700;color:white;">' + 'Xero : ' + group + " - " + NameArray[i] + '</td>' + buttonRow + '</tr>'
                                );
                            }
                            else {
                                if (typeArray[i] == "1") {
                                    ...
                                    $(rows).eq(i).before(
                                        '<tr class="group"><td colspan="7" style="BACKGROUND-COLOR:rgb(183, 172, 168);font-weight:700;color:#3E3A42;">' + 'Xero : ' + group + " - " + NameArray[i] + '</td>' + buttonRow + '</tr>'
                                    );
                                }
                                else {
                                    ...
                                    $(rows).eq(i).before(
                                        '<tr class="group"><td colspan="7" style="BACKGROUND-COLOR:rgb(255, 102, 102);font-weight:700;color:white;">' + 'Xero : ' + group + " - " + NameArray[i] + '</td>' + buttonRow + '</tr>'
                                    );
                                }
                            }
        ...
        function callCompanyNameByCreditID(dttId, type) {
            ...
            var coman = "";
                ...
                $.ajax({
                    ...
                    url: "../Fetch/FetchCompanynameByCreditId.aspx?orderlinePage=" + dttId.split(',')[0],
        ...
        function callCompanyNameByOrderID(dttId, type) {
            ...
            var coman = "";
                ...
                $.ajax({
                    ...
                    url: "../Fetch/FetchCompanynameByOrderId.aspx?orderlinePage=" + dttId.split(',')[0],
