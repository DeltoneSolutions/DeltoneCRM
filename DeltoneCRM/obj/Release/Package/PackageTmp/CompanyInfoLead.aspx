<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyInfoLead.aspx.cs" Inherits="DeltoneCRM.CompanyInfoLead"  MasterPageFile="~/BackButtonNav.Master" %>
   ...
   <%-- <script src="js/jquery-ui-1.10.3.custom.js"></script>--%>
    ...
    <script type="text/javascript">
        ...
        function EditOrder(OrderID, CompanyID, ContactID) {
            window.open("OrderLeadCompanyView.aspx?Oderid=" + OrderID + "&cid=" + ContactID + "&Compid=" + CompanyID);
        }
        ...
        $(document).ready(function () {
            ...
            $('#SaveCompNotes').click(function () {
                $.ajax({
                    type: "POST",
                    url: "Process/Process_AddLeadCompanyNotes.aspx",
                    data: {
...
<asp:Content ID="TheMainSection" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                        ...
                        <tr>
                            <td height="20px">
                                <input name='SaveCompNotes' type='button' id='SaveCompNotes' value='SAVE NOTES' />
                                  <input type="button" id="btn_schedulteEvent" style="margin-left: 50px;color:red;margin-left:20px;" onclick="openDialog();" value="Schedule Event" />
    ...
    width: 950px;word-wrap:break-word;display:inline-block;"></div>
            ...
            <tr>
                <td class="section_headings">PAST ORDERS LIST  <input type="button" onclick="showCreditSummary();" value="SUMMARY"
...
<%--<input value="ffcc00" type="text" id="addbgcolor" class="jscolor {width:243, height:150, position:'right',
 ...
 <option value="#800080" style="background-color:#800080;color:white;font-size:16px">    Call Back     </option> 
                       <%-- <option value="#008000" style="background-color:#008000"> Quote Follow Up </option>--%>
                        ...
                        <option value="#FFFF00" style="background-color:#FFFF00;font-size:16px" >  Auth Name   </option>
